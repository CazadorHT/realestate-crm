      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-200 leading-relaxed font-medium">
            ปัจจุบันองค์กรมีอัตราการปิดดีลเฉลี่ยที่ <span className="text-emerald-400 font-bold">{avgConversion.toFixed(1)}%</span> 
            โดยสาขา <span className="text-blue-400 font-bold">{topBranch?.tenantName}</span> มีประสิทธิภาพสูงสุด 
            ขณะที่ภาพรวมลีด {totalLeads > 50 ? "จัดอยู่ในเกณฑ์ที่น่าพอใจ" : "แนะนำให้เร่งการทำตลาด"}
          </p>
        </div>
        ...
        <div className="p-4 bg-white/5 rounded-xl border border-white/5 space-y-2 group hover:bg-white/10 transition-colors">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            สาขา <span className="text-rose-400 font-semibold">{bottomBranch?.tenantName}</span> มีประสิทธิภาพต่ำกว่าเกณฑ์เฉลี่ย 

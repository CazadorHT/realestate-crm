...
export function PropertyAdminHeader({ 
  ...
  const studioProperty = useMemo(() => {
    return {
      ...
      parking: (property as any).parking_slots ?? (property as any).parking ?? null,
      parking_slots: (property as any).parking_slots ?? null,
      is_foreigner_quota: (property as any).is_foreigner_quota ?? null,

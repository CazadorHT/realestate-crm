...
export function StatsTimeFilter() {
  ...
  const RANGES = [
    { label: isEn ? "All" : "ทั้งหมด", value: "all" },
    { label: isEn ? "This Month" : "เดือนนี้", value: "this-month" },
    { label: isEn ? "6 Months" : "6 เดือน", value: "6-months" },
    { label: isEn ? "1 Year" : "1 ปี", value: "1-year" },
    { label: "Q1", value: "q1" },
    { label: "Q2", value: "q2" },
    { label: "Q3", value: "q3" },
    { label: "Q4", value: "q4" },
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 mb-4">
      <div className="flex items-center gap-2 text-slate-500 mr-2">
        ...
        <span className="text-xs font-bold uppercase tracking-wider">{isEn ? "Time Range:" : "ช่วงเวลา:"}</span>
      </div>

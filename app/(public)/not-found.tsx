...
export default function PublicNotFound() {
  ...
  return (
    <div className="py-24 px-4 flex items-center justify-center bg-slate-50 min-h-[70vh]">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl border border-slate-100 p-8 text-center space-y-6 animate-in fade-in zoom-in duration-500">

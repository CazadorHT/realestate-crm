...
bot.command("start", (ctx) => {
  return ctx.reply(
    `📟 <b>ยินดีต้อนรับสู่ VCC Intelligence Hub</b>\n\nระบบจัดการและวิเคราะห์ข้อมูลอัจฉริยะ พร้อมใช้งานแล้วครับ\n\n<b>📊 คำสั่งด่วน (Quick Insights):</b>\n• /stats_monthly - สรุปยอดขายรายเดือน\n• /top_agent - Hall of Fame เอเยนต์มือทอง\n• /report - รายงานภาพรวมประจำวัน\n\n<b>🔍 จัดการข้อมูล:</b>\n• /check [ID] - ตรวจสอบข้อมูลทรัพย์สิน\n• /me - ดูสถานะและสิทธิ์ของคุณ\n• /help - ดูวิธีใช้งานทั้งหมด`,
    { parse_mode: "HTML" }
  );
});
...
bot.command("help", (ctx) => {
  return ctx.reply(
    `📖 <b>คู่มือการใช้งาน VCC Intelligence Bot</b>\n━━━━━━━━━━━━━━━━━━\n\n<b>📊 Business Intelligence:</b>\n• /stats_monthly - ดูสรุปยอด Lead ใหม่ และดีลที่ปิดได้ประจำเดือนนี้\n• /top_agent - แสดง 5 อันดับเอเยนต์ที่มีผลงานโดดเด่นที่สุด\n• /report - สรุปสถิติพื้นฐานประจำวัน\n\n<b>🏠 Management:</b>\n• /check [ID] - ตรวจสอบข้อมูลทรัพย์สินเชิงลึก\n• /me - ตรวจสอบ Telegram ID และสิทธิ์การใช้งาน\n\n<b>⚡️ การจัดการหน้างาน:</b>\n• ระบบจะแจ้งเตือนเมื่อมี <b>"Lead ใหม่"</b> หรือ <b>"ทรัพย์ลดราคา 🔥"</b> ทันทีในกลุ่มพนักงาน\n• คุณสามารถกดปุ่ม <b>"รับงาน"</b> หรือ <b>"Sold"</b> ได้โดยตรงจากข้อความแจ้งเตือนครับ`,
    { parse_mode: "HTML" }
  );
});

        ...
        <div className="max-w-md w-full text-center space-y-8 animate-in fade-in duration-700">
          ...
          <div className="flex flex-col gap-4">
            <Button
              onClick={() => reset()}
              size="lg"
              className="bg-white text-slate-900 hover:bg-slate-200 h-14 rounded-2xl font-bold text-lg transition-all active:scale-95 shadow-2xl"
            >
              พยายามกู้คืนระบบ (Reload)
            </Button>
            ...
            >
              ส่งรายงานปัญหา (Send Error Report)
            </Button>
          </div>
        </div>
      </body>

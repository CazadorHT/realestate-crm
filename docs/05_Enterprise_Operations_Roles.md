...
## 🏢 ระบบรองรับหลายสาขา/หลายบริษัท (Multi-Tenant Branch Switcher) 🆕

ระบบถูกออกแบบมาให้รองรับองค์กรขนาดใหญ่ที่มีสาขาหรือมีบริษัทย่อยหลายแห่ง:

1. **สลับสาขาง่ายดาย (Branch Switcher)**: Admin หรือ Manager ที่ดูแลหลายสาขาสามารถเปลี่ยน Context ไปมาระหว่างสาขาผ่าน Dropdown บนแถบ Navbar (Tenant Switcher) ได้ทันทีโดยไม่ต้อง Log in ใหม่
2. **คลังทรัพย์สินส่วนกลาง (Global vs. Local Inventory)**: สาขาสามารถมีทรัพย์สินเฉพาะของตนเอง หรือแชร์ทรัพย์สินกับส่วนกลางได้ตามนโยบายบริษัท
3. **การคุมสิทธิ์รายสาขา**: Agent จะถูกผูกติดกับสาขาของตนเอง ทำให้ไม่เห็นข้อมูล Leads หรือ Deals จากสาขาอื่น จึงมั่นใจได้ในเรื่องความปลอดภัยของข้อมูล

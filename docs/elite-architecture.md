...
**IMPORTANT**
* คำแนะนำสำหรับการพัฒนาต่อ: ระบบปัจจุบันมีฐานที่แข็งแกร่งมากแล้ว หากในอนาคตมีการเพิ่มฟิลด์ใหม่ในตาราง properties ที่ต้องการเก็บเป็นความลับ (Internal) อย่าลืมระบุ Column นั้นลงใน AuditMetadata เพื่อให้ระบบ Scrubber ช่วย Mask ข้อมูลให้อัตโนมัติครับ
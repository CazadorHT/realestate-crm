-- Migration: Add HOME_OFFICE property_type (value 11)
-- Date: 2026-07-17

-- 1. Recreate the properties view to support property_type = 11 -> 'HOME_OFFICE'
 ...
 SELECT "c"."id",
    ...
    "c"."property_type" AS "property_type_int",
        CASE
            ...
            WHEN ("c"."property_type" = 11) THEN 'HOME_OFFICE'::"text"
            ELSE 'OTHER'::"text"
...
-- 2. Update smart_match_rpc match_properties_hardened function
...
-- Re-grant permissions for match_properties_hardened

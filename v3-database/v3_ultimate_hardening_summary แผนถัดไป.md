...
* **Direct V3 Core Joins & Sunset Legacy Views:** ทำการย้ายสถาปัตยกรรมเข้าสู่ตารางหลัก V3 Core (`crm_leads_v3`, `identities_v3`, และ `communications_hub_v3`) โดยตรง เพื่อยกเลิกการเรียกผ่าน "สะพาน" (View Bridge `leads`, `communications_hub_v3`) ที่เป็นระเบิดเวลา (Time Bomb) ในการจัดการข้อมูลระบุตัวตน (เช่น `line_id`, `facebook_psid`, `instagram_sid`)

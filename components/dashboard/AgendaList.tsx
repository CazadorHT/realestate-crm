...
import { TODAY_AGENDA } from "@/lib/dashboard-data";
          ...
          {TODAY_AGENDA.map((event) => {
            ...
            return (
              <div key={event.id} className="ml-4 relative">
                <div className={`absolute -left-[21px] top-1 h-3 w-3 rounded-full ring-4 ${dotColor}`} />
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                     ...
                     {event.priority === "high" && <span className="text-[10px] text-red-600 font-bold bg-red-50 px-1 rounded">Important</span>}
                  </div>
                </div>
              </div>
            );

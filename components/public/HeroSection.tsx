...
export function HeroSection() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-900 overflow-x-hidden">
      <Image
        src={
          siteSettings?.brand_hero_image_url || "/images/hero-realestate.png"
        }
        alt="Hero Background"
        fill
        priority
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <Shield className="h-4 w-4 sm:h-5 sm:w-5 text-[hsl(var(--brand-primary))] drop-shadow" />
                  <span className="text-xs sm:text-sm text-white/90 drop-shadow-sm">
                    {t("common.safe_transaction")}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <Clock className="h-4 w-4 sm:h-5 sm:w-5 text-[hsl(var(--brand-secondary))] drop-shadow" />
                  <span className="text-xs sm:text-sm text-white/90 drop-shadow-sm">

              ...
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    ...
                    className="min-h-[100px] resize-none border-slate-200  focus:bg-white! focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all rounded-xl shadow-sm"
                    {...field}
                  />
                </FormControl>
                <FormMessage className="font-medium" />

  ...
  const specs = [
    {
      ...
      icon: <BedDouble className="w-4 h-4 md:w-6 md:h-6 text-[hsl(var(--brand-primary))]" />,
      show: true,
    },
    {
      ...
      value: bathrooms,
      suffix: t("property.specs.unit_room"),
      icon: <Bath className="w-4 h-4 md:w-6 md:h-6 text-[hsl(var(--brand-primary))]" />,
      show: true,
    },
    {
      ...
      icon: <Maximize className="w-4 h-4 md:w-6 md:h-6 text-[hsl(var(--brand-primary))]" />,
      show: !!sizeSqm,
    },
    {
      ...
      icon: <Home className="w-4 h-4 md:w-6 md:h-6 text-[hsl(var(--brand-primary))]" />,
      show: !!landSize,
    },
    {
      ...
      icon: <Car className="w-4 h-4 md:w-6 md:h-6 text-[hsl(var(--brand-primary))]" />,
      show: !!parking,
    },
    {
      ...
      icon: <Building2 className="w-4 h-4 md:w-6 md:h-6 text-[hsl(var(--brand-primary))]" />,
      show: !!floor,
    },
  ].filter(

    ...
    >
      <article className="flex flex-col h-full overflow-hidden rounded-2xl border border-slate-200 bg-card transition-all duration-300 hover:shadow-card hover:-translate-y-1">
        ...
        <div className="flex flex-col flex-1 p-6 bg-white">
          ...
          <h3 className="text-xl font-bold mb-2 line-clamp-2 group-hover:text-[hsl(var(--brand-primary))] transition-colors">
            {title}
          </h3>
          ...
          <div className="flex items-center justify-between mt-auto">
            ...
            <span className="inline-flex items-center text-sm font-semibold text-[hsl(var(--brand-primary))] group-hover:translate-x-1 transition-transform">
...
const getCategoryColor = (category: string) => {
  const colors = [
    "bg-[var(--brand-primary-50)] text-[var(--brand-primary-800)] dark:bg-[var(--brand-primary-900)/30] dark:text-[var(--brand-primary-200)]",
    "bg-[var(--brand-secondary-100)] text-[var(--brand-secondary-800)] dark:bg-[var(--brand-secondary-900)/30] dark:text-[var(--brand-secondary-200)]",

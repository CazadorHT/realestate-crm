        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="shrink-0 sticky bottom-0 px-5 pt-2 pb-[calc(env(safe-area-inset-bottom,12px)+16px)] bg-white/95 backdrop-blur-xl z-20 border-t border-slate-50 shadow-[0_-8px_30px_rgba(0,0,0,0.04)]"
            >

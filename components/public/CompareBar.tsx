...
export function CompareBar() {
  ...
  return (
    <div className="fixed bottom-24 md:bottom-4 left-0 right-0 z-50 px-4">
      <div className="max-w-xl lg:max-w-3xl mx-auto rounded-3xl border border-slate-200 bg-white shadow-xl p-3 flex flex-col sm:flex-row items-center justify-between gap-3">

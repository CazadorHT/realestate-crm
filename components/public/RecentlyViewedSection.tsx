...
export function RecentlyViewedSection({
  ...
  return (
    <section className="min-h-[450px] md:min-h-[500px] py-10 md:py-12 px-4 md:px-6 lg:px-8 bg-blue-50/30 border-y border-blue-100/50 overflow-hidden relative z-0">

          ...
          {loading
            ...
            : posts.map((post, index) => (
                ...
                >
                  <Link
                    href={`/blog/${post.slug}`}
                    className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 border border-slate-100 flex flex-col h-full"
                  >
                    {/* Image */}

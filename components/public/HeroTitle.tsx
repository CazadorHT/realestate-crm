  ...
  return (
    <div className="flex justify-center lg:justify-start text-center lg:text-left w-full">
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold leading-tight flex flex-col  items-center lg:block">
        ...
        <span className="relative inline-flex items-center lg:ml-3 h-[1.2em] overflow-hidden align-middle">
          <span
            key={index}
            className="bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent animate-in fade-in slide-in-from-bottom-2 duration-500 leading-none whitespace-nowrap"
          >
            {words[index] || ""}
          </span>
        </span>

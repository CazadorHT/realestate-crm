        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 md:gap-6">
          ...
          <div className="space-y-1.5 md:space-y-3">
            <nav className="flex flex-wrap items-center gap-1 text-[8px] md:text-[10px] font-semibold uppercase tracking-widest md:tracking-[0.2em] text-slate-400">
              <Link href="/protected/settings" className=" hover:text-blue-600 transition-colors whitespace-nowrap italic">
                การตั้งค่า (Settings)
              </Link>
              ...
              {subPath.length === 0 && (
                <>
                  <ChevronRight className="h-3 w-3 text-slate-300" />
                  <span className="text-blue-600/80 whitespace-nowrap italic">ระบบควบคุมความปลอดภัย (System Control)</span>
                </>
              )}
            </nav>
            ...
            >
              <h1 className="text-xl md:text-3xl lg:text-4xl font-semibold tracking-tight text-slate-900 leading-tight">
                {title || (
                  <>
                    การตั้งค่าระบบ <span className="bg-linear-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent italic pr-1">(System Settings)</span>
                  </>
                )}
              </h1>
              {description && (
        ...
        <div className="flex flex-col items-start lg:items-end gap-3 mt-2 lg:mt-0">
          <div className="flex flex-row items-center gap-2 md:gap-3">
            ...
            >
              ...
              <span className="text-[10px] md:text-xs font-semibold uppercase tracking-wider">สถานะ: ปกติ (Operational)</span>
            </motion.div>
            ...
            <div className="hidden sm:flex items-center gap-2 rounded-2xl border border-slate-200 bg-white/50 px-5 py-2.5 text-slate-600 shadow-sm backdrop-blur-md">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider italic text-slate-500">Elite Hardened</span>
            </div>
          </div>

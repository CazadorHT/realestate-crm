...
export function SettingsTabs({ activeTab }: SettingsTabsProps) {
  ...
  return (
    <div className="w-full overflow-x-auto pb-4 scrollbar-hide">
      <TabsList className="flex items-center w-max md:w-auto h-auto p-1.5 bg-slate-100/80 backdrop-blur-md rounded-2xl gap-1.5 border border-slate-200/60 shadow-inner">

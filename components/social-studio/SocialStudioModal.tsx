                ...
                {activeTab === "content" && (
                  <div className="space-y-4 animate-in fade-in duration-200">
                    <StudioContentEditor
                      ...
                      textEffectCardMode={state.textEffectCardMode}
                      setTextEffectCardMode={state.setTextEffectCardMode}
                      textEffectSingleCardBgColor={state.textEffectSingleCardBgColor}
                      setTextEffectSingleCardBgColor={state.setTextEffectSingleCardBgColor}
                      textEffectSingleCardTextColor={state.textEffectSingleCardTextColor}
                      setTextEffectSingleCardTextColor={state.setTextEffectSingleCardTextColor}
                      textEffectSingleCardBorderColor={state.textEffectSingleCardBorderColor}
                      setTextEffectSingleCardBorderColor={state.setTextEffectSingleCardBorderColor}
                      textEffectSingleCardBorderWidth={state.textEffectSingleCardBorderWidth}
                      setTextEffectSingleCardBorderWidth={state.setTextEffectSingleCardBorderWidth}
                      textEffectSingleCardRadius={state.textEffectSingleCardRadius}
                      setTextEffectSingleCardRadius={state.setTextEffectSingleCardRadius}
                      textEffectSingleCardPadding={state.textEffectSingleCardPadding}
                      setTextEffectSingleCardPadding={state.setTextEffectSingleCardPadding}
                      textEffectSingleCardAlign={state.textEffectSingleCardAlign}
                      setTextEffectSingleCardAlign={state.setTextEffectSingleCardAlign}
                      textEffectSingleCardOpacity={state.textEffectSingleCardOpacity}
                      setTextEffectSingleCardOpacity={state.setTextEffectSingleCardOpacity}
                      calloutPointers={state.calloutPointers}

...
function AuthProviderBadge({ provider }: { provider: string }) {
  if (provider === "google") {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-full bg-white border border-slate-200 px-2.5 py-1 text-[11px] font-semibold text-slate-700 shadow-sm">
        {/* Google colour-dot */}
  ...
  if (provider === "facebook") {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-full bg-[#1877F2]/10 border border-[#1877F2]/20 px-2.5 py-1 text-[11px] font-semibold text-[#1877F2] shadow-sm">
        <svg
          viewBox="0 0 24 24"
          className="h-3.5 w-3.5 fill-[#1877F2]"
          aria-hidden
        >
  ...
  // default = email
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 border border-slate-200 px-2.5 py-1 text-[11px] font-semibold text-slate-600 shadow-sm">

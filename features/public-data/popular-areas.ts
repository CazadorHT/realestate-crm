...
export async function getPopularAreasAction(province?: string): Promise<PopularAreaItem[]> {
  try {
    ...
    const areaTranslations = new Map<string, { en: string | null; cn: string | null }>();

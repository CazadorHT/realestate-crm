...
export function DocumentActions({ document: doc, tenantId }: DocumentActionsProps) {
  ...
  return (
    <ResponsiveDialog
      ...
      title="จัดการเอกสาร"
      description="เลือกเครื่องมือวิเคราะห์หรือจัดการข้อมูลเพิ่มเติม"
    >
          ...
          trigger={
            ...
            >
              ...
              <div className="text-left">
                <p className="font-bold text-sm">ประวัติเวอร์ชัน</p>
                <p className="text-[10px] text-slate-400 font-medium">ดูและอัปโหลดไฟล์ชุดใหม่เข้าประวัติ</p>
              </div>
            </Button>
          }
        />
        ...
        <ESignDialog
          ...
          trigger={
            ...
            >
              ...
              <div className="text-left">
                <p className="font-bold text-sm">จัดการ E-Signature</p>
                <p className="text-[10px] text-slate-400 font-medium">ยืนยันการเซ็นชื่อและอัปเดตสถานะสัญญา</p>
              </div>
            </Button>
          }
        />
        ...
        <AIDocumentInsight
          ...
          trigger={
            ...
            >
              ...
              <div className="text-left">
                <p className="font-bold text-sm">วิเคราะห์ด้วย AI</p>
                <p className="text-[10px] text-slate-400 font-medium">สรุปเนื้อหาและตรวจสอบจุดเสี่ยงอัตโนมัติ</p>
              </div>
            </Button>
          }
        />

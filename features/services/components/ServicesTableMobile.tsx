                ...
                {!isTrashView ? (
                  <>
                      <Button
                        size="sm"
                        variant="outline"
                        className="h-9 px-3 text-xs border-slate-200 text-slate-600"
                  ...
                  <>
                      <Button
                        ...
                        disabled={isPending}
                      >
                        <RefreshCcw className={cn("w-3.5 h-3.5 mr-2", isPending && "animate-spin")} />
                        กู้คืน
                      </Button>
                    <Button
                      variant="outline"
                      size="icon"
                      className="h-9 w-9 text-rose-700 border-rose-100 bg-rose-50/50 hover:bg-rose-50 rounded-xl"

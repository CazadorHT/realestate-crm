        ...
        <Card className="md:col-span-2 border-0 shadow-lg bg-linear-to-br from-indigo-500 to-blue-600 text-white relative overflow-hidden">
          ...
          <CardHeader>
            <CardTitle className="text-xl font-bold flex items-center gap-2 text-white">
              ...
              {isEn ? "AI Executive Summary" : "สรุปภาพรวมสำหรับผู้บริหาร (AI Executive Summary)"}
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-0 shadow-lg bg-white border-l-4 border-amber-400">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-bold text-slate-500 uppercase tracking-wider flex items-center gap-2">
              ...
              {isEn ? "Next Month Forecast" : "พยากรณ์เดือนถัดไป (Forecast)"}
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-0 shadow-md bg-white/50 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-base font-bold flex items-center gap-2 text-slate-800">
              ...
              {isEn ? "Key Observations & Trends" : "ข้อสังเกตและแนวโน้มสำคัญ"}
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="flex items-start gap-3 p-4 bg-slate-100/50 border border-slate-200 rounded-xl text-slate-500 mt-4">
        ...
        <div className="text-[11px] leading-relaxed italic">
          <p className="font-bold text-slate-600 mb-0.5">
            {isEn ? "⚠️ AI Usage Disclaimer:" : "⚠️ ข้อมูลการใช้งานระบบ AI (AI Usage Disclaimer):"}
          </p>
          {isEn
            ? "This forecast and strategic briefing is generated by Generative AI for preliminary advisory purposes only. Please verify calculations against official CRM statistical and accounting reports prior to business decisions."

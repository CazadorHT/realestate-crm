      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-6 bg-linear-to-br from-indigo-50 to-white rounded-3xl border border-indigo-100 shadow-sm relative group">
          ...
          <div className="flex items-center justify-between mb-4">
            <Badge className="bg-indigo-600 hover:bg-indigo-700 border-none px-3 font-bold">ดีลเด่น</Badge>
            <ArrowUpRight className="w-4 h-4 text-indigo-300 group-hover:text-indigo-600 transition-colors" />
          </div>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">ปิดดีลสูงสุดต่อชิ้น</p>
        ...
        <div className="p-6 bg-linear-to-br from-emerald-50 to-white rounded-3xl border border-emerald-100 shadow-sm relative group">
          ...
          <div className="flex items-center justify-between mb-4">
            <Badge className="bg-emerald-600 hover:bg-emerald-700 border-none px-3 font-bold">ภาษีสะสม</Badge>
            <TrendingUp className="w-4 h-4 text-emerald-300 group-hover:text-emerald-600 transition-colors" />
          </div>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">ยอดหัก ณ ที่จ่าย (WHT) รวม</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h4 className="text-sm font-bold text-slate-900">ดาวน์โหลดหนังสือรับรอง 50 ทวิ</h4>
                <Badge variant="outline" className="border-indigo-200 text-indigo-600 text-[8px] px-1.5 font-bold h-4">เร็วๆ นี้</Badge>
              </div>
              <p className="text-[11px] text-slate-400 font-medium font-thai">ใช้สำหรับยื่นภาษีเงินได้บุคคลธรรมดาประจำปี เพื่อขอคืนภาษี</p>
            </div>
          </div>
        </Card>
      </div>
